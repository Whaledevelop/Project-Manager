<?php
  ...
  function renderMessagesPanel($userId) {
    ...
    $messagesFolderHref = $_SESSION['rootHref']."/cabinet/messages";
    return "
      <div class = \"col-lg-6 pagePanel messagesPanel\">
        <h5 class=\"pageSubheader\">Панель сообщений</h5>
        <ul>
          <li>
            <a href=\"".$messagesFolderHref."/incomingMessages.php\">
              Входящие (".$unreadStatus.")
            </a>
          </li>
          <li><a href=\"".$messagesFolderHref."/outcomingMessages.php\">
            Исходящие сообщения
          </a></li>
        </ul>
        <div class = \"row justify-content-center\">
          <a class=\"whiteLink\" 
            href=\"".$messagesFolderHref."/writeMessage.php\"
          >
